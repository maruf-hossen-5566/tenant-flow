                        ...
                        <ItemGroup className="gap-2">
                            {activeMembers?.map((m) => (
                                ...
                                >
                                    <ItemMedia>
                                        <Avatar>
                                            <AvatarFallback className="capitalize">{m?.user?.name?.charAt(0) || m?.user_email?.charAt(0)}</AvatarFallback>
                                        </Avatar>
                                    </ItemMedia>
                                    <ItemContent className="w-full flex flex-row items-center justify-between">
                                        <div className="">
                                            <ItemTitle className="flex flex-col items-start gap-0">{m?.user?.name}</ItemTitle>
                                            <ItemDescription>
                                                <span>
                                            ...
                                            <HoverCard>
                                                ...
                                                >
                                                    <Button variant="ghost">
                                                        {
                                                            m?.member_projects?.slice(0, 1)?.map(p => (
                                                                <Badge
                                                                    key={p?.id}
                                                        ...
                                                        {
                                                            m?.member_projects?.length > 1 && (
                                                                <span
                                                                    className="text-xs ml-0.5 mr-1.5"
                                                                >+{m?.member_projects?.length - 1}</span>
                                                            )
                                                        }
                                                        <ChevronDown/>
                                                    </Button>
