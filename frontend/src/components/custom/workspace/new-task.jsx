...
const NewTask = ({data, setData, members}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            cleanedData["assignee_id"] = draftTask?.assignee ? draftTask?.assignee : null
            cleanedData["project_id"] = projectId

            const {sd, dd} = validateStartAndEndDate(draftTask?.startDate, draftTask?.dueDate)
                        ...
                        <FieldGroup>
                            <Field>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setDraftTask("name", e?.target?.value)}
                                    required
                                />
                            </Field>
                            <Field>
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) => setDraftTask("desc", e?.target?.value)}
                                />
                            </Field>
                            <Field>
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => setDraftTask("assignee", value || null)}
                                >
                            ...
                            <Field>
                                ...
                                >
                                    <PopoverTrigger asChild>
                                        ...
                                        >
                                            {draftTask?.startDate ? moment(draftTask?.startDate).format("MMM DD, YYYY") : "--"}
                                            <ChevronDownIcon/>
                                        </Button>
                                    </PopoverTrigger>
                                    <PopoverContent
                                ...
                                >
                                    <PopoverTrigger asChild>
                                        <Button
                                            ...
                                            className="w-48 justify-between font-normal text-muted-foreground"
                                        >
                                            {draftTask?.dueDate ? moment(draftTask?.dueDate).format("MMM DD, YYYY") : "--"}
                                            <ChevronDownIcon/>
                                        </Button>
                                    </PopoverTrigger>
                                    <PopoverContent
